...
def emulate_function_async(*args, **kwargs):
    warnings.warn("ai_agent.libs.rz_emulator.emulate_function_async is deprecated. Use ai_agent.core.emulation.emulate_function instead.", DeprecationWarning, stacklevel=2)
