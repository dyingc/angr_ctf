...
def main(argv):
  ...
  class ReplacementCheckEquals(angr.SimProcedure):
    ...
    # (!)
    def run(self, to_check:claripy.BVS, length:claripy.BVV):
      ...
      check_against_string = self.state.memory.load(0x0804e02c, size=user_input_buffer_length)
  ...
  # (!)
  check_equals_symbol = project.loader.find_symbol('check_equals_ANBHYDCNMNRPQWPX').name # :string
