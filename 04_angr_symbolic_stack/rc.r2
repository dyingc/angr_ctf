...
"e prj.gpg = false"
"e prj.history = false"
"e prj.name = 04_angr_symbolic_stack"
"e prj.sandbox = false"
"e prj.vc = true"
"e prj.vc.message = "
"e prj.vc.type = git"
...
"e zoom.maxsz = 512"
"e zoom.to = 0"
o "04_angr_symbolic_stack" 0x08048000 r-x
...
om $d 0x20000000 0x000f0000 0x00000000 rw- mem.0x20000000_0xf0000
onnu malloc://983040 rw-
om $d 0x30000000 0x000f0000 0x00000000 rw- mem.0x30000000_0xf0000
omu 4 0x0804c018 0x00000004 0x00000000 rw- mmap.LOAD3
omu 3 0x0804bf00 0x00000118 0x00002f00 r-- fmap.LOAD3
omu 3 0x0804a000 0x000001d4 0x00002000 r-- fmap.LOAD2
omu 3 0x08049000 0x00000438 0x00001000 r-x fmap.LOAD1
...
omu 5 0x10000000 0x000f0000 0x00000000 rw- mem.0x10000000_0xf0000
omu 5 0x20000000 0x000f0000 0x00000000 rw- mem.0x20000000_0xf0000
omu 6 0x30000000 0x000f0000 0x00000000 rw- mem.0x30000000_0xf0000
tcc eax borland (eax, edx, ecx, stack_rev, stack_rev, stack_rev, stack_rev);
tcc eax cdecl (stack);
tcc eax cdecl-fastcall-ms (ecx, stack);
tcc eax:edx:edx:edx:edx dlang (edi, esi, edx, ecx, r8d, r9d, stack_rev, stack_rev, stack_rev, stack_rev); // revarg
tcc eax fastcall (ecx, edx, stack);
tcc eax optlink (eax, edx, ecx, stack);
tcc eax pascal (stack_rev, stack_rev, stack_rev, stack_rev);
...
s-
afS 0 @ 0x80490c0
"f sym.complex_function0 232 0x080491a4"
"af+ 0x080491a4 sym.complex_function0 f n"
afb+ 0x080491a4 0x080491a4 232 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x080491a4
s 0x80491a4
"afc cdecl"
s-
s 0x80491a4
'afvb 8 arg_8h int32_t
s-
afS 4 @ 0x80491a4
"f sym._fini 20 0x08049424"
"af+ 0x08049424 sym._fini f n"
afb+ 0x08049424 0x08049424 20 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049424
s 0x8049424
"afc cdecl"
s-
axC 0x80490c0 0x8049428
afS 12 @ 0x8049424
"f sym.handle_user 124 0x08049374"
"af+ 0x08049374 sym.handle_user f n"
afb+ 0x08049374 0x08049374 76 0x080493ca 0x080493c0
afb+ 0x08049374 0x080493c0 10 0x080493dc 0x080493ca
afb+ 0x08049374 0x080493ca 18 0x080493ed 0xffffffffffffffff
afb+ 0x08049374 0x080493dc 17 0x080493ed 0xffffffffffffffff
afb+ 0x08049374 0x080493ed 3 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049374
s 0x8049374
"afc cdecl"
s-
s 0x8049374
'afvb -12 password0 int32_t
'afvb -16 password1 int32_t
s-
axd 0x804a00b 0x8049385
axC 0x8049060 0x804938a
axC 0x80491a4 0x8049399
axC 0x804928c 0x80493ab
axc 0x80493ca 0x80493be
axc 0x80493dc 0x80493c8
axd 0x804a011 0x80493cd
axC 0x8049050 0x80493d2
axc 0x80493ed 0x80493da
axd 0x804a01c 0x80493df
axC 0x8049050 0x80493e4
afS 44 @ 0x8049374
...
s-
afS 0 @ 0x80490b0
"f sym.complex_function1 232 0x0804928c"
"af+ 0x0804928c sym.complex_function1 f n"
afb+ 0x0804928c 0x0804928c 232 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x0804928c
s 0x804928c
"afc cdecl"
s-
...
s-
afS 4 @ 0x804928c
"f main 51 0x080493f0"
"af+ 0x080493f0 main f n"
afb+ 0x080493f0 0x080493f0 51 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x080493f0
s 0x80493f0
"afc cdecl"
s-
...
'afvs 4 argv char **
s-
axd 0x804a026 0x8049404
axC 0x8049040 0x8049409
axC 0x8049374 0x8049411
afS 32 @ 0x80493f0
...
f section..symtab 704 0x00000000 
f section..strtab 557 0x00000000 
...
f elf_shstrtab 257 0x00003525 
f elf_shdr 40 0x00003628 
fs segments
...
fs segments
f segment.LOAD1 1080 0x08049000 
fs symbols
f sym._init 32 0x08049000 
fs sections
...
fs symbols
f main 51 0x080493f0 
f sym.main 51 0x080493f0 
fs sections
f section..fini 20 0x08049424 
fs symbols
f sym._fini 20 0x08049424 
fs sections
f section..rodata 59 0x0804a000 
fs segments
f segment.LOAD2 468 0x0804a000 
fs symbols
f obj._fp_hw 4 0x0804a000 
f obj._IO_stdin_used 4 0x0804a004 
fs strings
f str._u__u 6 0x0804a00b 
f str.Try_again. 11 0x0804a011 
f str.Good_Job. 10 0x0804a01c 
f str.Enter_the_password: 21 0x0804a026 
fs sections
f section..eh_frame_hdr 76 0x0804a03c 
fs segments
f segment.GNU_EH_FRAME 76 0x0804a03c 
fs symbols
f loc.__GNU_EH_FRAME_HDR 0 0x0804a03c 
fs sections
f section..eh_frame 300 0x0804a088 
fs symbols
f obj.__FRAME_END__ 0 0x0804a1b0 
fs sections
f section..note.ABI_tag 32 0x0804a1b4 
fs segments
f segment.NOTE_1 32 0x0804a1b4 
fs symbols
f obj.__abi_tag 32 0x0804a1b4 
fs sections
...
CCu base64:WzEyXSAtci14IHNlY3Rpb24gc2l6ZSA5NDcgbmFtZWQgLnRleHQ= @ 0x08049070
Ct char **ubp_av @ 0x0804908a
Ct int argc @ 0x0804908b
Ct func main @ 0x08049092
Ct const char *format @ 0x08049194
Ct int32_t arg_8h @ 0x08049398
Ct int32_t arg_8h @ 0x080493aa
CCu base64:WzEzXSAtci14IHNlY3Rpb24gc2l6ZSAyMCBuYW1lZCAuZmluaQ== @ 0x08049424
CCu base64:WzE0XSAtci0tIHNlY3Rpb24gc2l6ZSA1OSBuYW1lZCAucm9kYXRh @ 0x0804a000
Cs 6 @ 0x0804a00b # %u %u
Cs 11 @ 0x0804a011 # Try again.
Cs 10 @ 0x0804a01c # Good Job.
Cs 21 @ 0x0804a026 # Enter the password: 
CCu base64:WzE1XSAtci0tIHNlY3Rpb24gc2l6ZSA3NiBuYW1lZCAuZWhfZnJhbWVfaGRy @ 0x0804a03c
CCu base64:WzE2XSAtci0tIHNlY3Rpb24gc2l6ZSAzMDAgbmFtZWQgLmVoX2ZyYW1l @ 0x0804a088
CCu base64:WzE3XSAtci0tIHNlY3Rpb24gc2l6ZSAzMiBuYW1lZCAubm90ZS5BQkktdGFn @ 0x0804a1b4
Cd 4 @ 0x0804bf00
...
"tk func.sym.complex_function0.arg.0=int32_t,arg_8h"
"tk func.sym.complex_function0.args=1"
"tk func.sym.complex_function1.arg.0=int32_t,arg_8h"
"tk func.sym.complex_function1.args=1"
