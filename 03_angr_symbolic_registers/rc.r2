...
"e http.homeroot = /home/edong/.local/share//radare2/www"
...
"e http.port = 9090"
"e http.referer = "
"e http.root = /usr/local/share/radare2/5.9.4/www"
"e http.sandbox = true"
"e http.sync = "
"e http.timeout = 3"
"e http.ui = m"
...
"e pdb.symstore = /home/edong/.local/share//radare2/pdb"
"e pdb.useragent = microsoft-symbol-server/6.11.0001.402"
"e prj.alwasyprompt = false"
"e prj.files = false"
"e prj.gpg = false"
"e prj.history = false"
"e prj.name = 03_angr_symbolic_registers"
"e prj.sandbox = false"
"e prj.vc = true"
"e prj.vc.message = "
"e prj.vc.type = git"
...
"e r2ghidra.roprop = 0"
"e r2ghidra.sleighhome = /home/edong/.local/share/radare2/plugins/r2ghidra_sleigh"
...
"e zoom.maxsz = 512"
"e zoom.to = 0"
o "./03_angr_symbolic_registers" 0x08048000 r-x
om $d 0x0804ee00 0x00000118 0x00000000 r-- fmap.LOAD3
om $d 0x0804ee00 0x00000118 0x00000000 r-- fmap.LOAD3
onnu null://4 rw-
onnu malloc://983040 rw-
om $d 0x00100000 0x000f0000 0x00000000 rw- mem.0x100000_0xf0000
onnu malloc://983040 rw-
om $d 0x10000000 0x000f0000 0x00000000 rw- mem.0x10000000_0xf0000
omu 4 0x0804c018 0x00000004 0x00000000 rw- mmap.LOAD3
omu 3 0x0804bf00 0x00000118 0x00002f00 r-- fmap.LOAD3
omu 3 0x0804a000 0x00000200 0x00002000 r-- fmap.LOAD2
omu 3 0x08049000 0x000005e8 0x00001000 r-x fmap.LOAD1
omu 3 0x08048000 0x00000368 0x00000000 r-- fmap.LOAD0
omu 3 0x0804ee00 0x00000118 0x00000000 r-- fmap.LOAD3
omu 5 0x00100000 0x000f0000 0x00000000 rw- mem.0x100000_0xf0000
omu 6 0x10000000 0x000f0000 0x00000000 rw- mem.0x10000000_0xf0000
tcc eax borland (eax, edx, ecx, stack_rev, stack_rev);
tcc eax cdecl (stack);
tcc eax cdecl-fastcall-ms (ecx, stack);
tcc eax:edx:edx dlang (edi, esi, edx, ecx, r8d, r9d, stack_rev, stack_rev); // revarg
tcc eax fastcall (ecx, edx, stack);
tcc eax optlink (eax, edx, ecx, stack);
tcc eax pascal (stack_rev, stack_rev);
tcc eax reg (eax, ebx, ecx, edx);
tcc eax stdcall (stack);
tcc eax watcom (eax, edx, ebx, ecx, stack);
# functions
fs functions
"f sym.imp.__libc_start_main 6 0x08049030"
"af+ 0x08049030 sym.imp.__libc_start_main f n"
afb+ 0x08049030 0x08049030 6 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049030
s 0x8049030
"afc cdecl"
s-
axc 0x804c000 0x8049030
afS 0 @ 0x8049030
"f sym.imp.printf 6 0x08049040"
"af+ 0x08049040 sym.imp.printf f n"
afb+ 0x08049040 0x08049040 6 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049040
s 0x8049040
"afc cdecl"
s-
axc 0x804c004 0x8049040
afS 0 @ 0x8049040
"f sym.imp.puts 6 0x08049050"
"af+ 0x08049050 sym.imp.puts f n"
afb+ 0x08049050 0x08049050 6 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049050
s 0x8049050
"afc cdecl"
s-
axc 0x804c008 0x8049050
afS 0 @ 0x8049050
"f sym.imp.__isoc99_scanf 6 0x08049060"
"af+ 0x08049060 sym.imp.__isoc99_scanf f n"
afb+ 0x08049060 0x08049060 6 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049060
s 0x8049060
"afc cdecl"
s-
axc 0x804c00c 0x8049060
afS 0 @ 0x8049060
"f entry0 40 0x08049070"
"af+ 0x08049070 entry0 f n"
afb+ 0x08049070 0x08049070 40 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049070
s 0x8049070
"afc cdecl"
s-
axC 0x8049099 0x804907b
axC 0x8049030 0x8049093
afS 28 @ 0x8049070
"f fcn.08049099 4 0x08049099"
"af+ 0x08049099 fcn.08049099 f n"
afb+ 0x08049099 0x08049099 4 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049099
s 0x8049099
"afc cdecl"
s-
afS 0 @ 0x8049099
"f sym.deregister_tm_clones 49 0x080490d0"
"af+ 0x080490d0 sym.deregister_tm_clones f n"
afb+ 0x080490d0 0x080490d0 12 0x08049100 0x080490dc
afb+ 0x080490d0 0x080490dc 9 0x08049100 0x080490e5
afb+ 0x080490d0 0x080490e5 18 0xffffffffffffffff 0xffffffffffffffff
afb+ 0x080490d0 0x08049100 1 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x080490d0
s 0x80490d0
"afc cdecl"
s-
axd 0x804c018 0x80490d0
axd 0x804c018 0x80490d5
axc 0x8049100 0x80490da
axc 0x8049100 0x80490e3
axd 0x804c018 0x80490eb
afS 28 @ 0x80490d0
"f sym.register_tm_clones 57 0x08049110"
"af+ 0x08049110 sym.register_tm_clones f n"
afb+ 0x08049110 0x08049110 24 0x08049148 0x08049128
afb+ 0x08049110 0x08049128 9 0x08049148 0x08049131
afb+ 0x08049110 0x08049131 19 0xffffffffffffffff 0xffffffffffffffff
afb+ 0x08049110 0x08049148 1 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049110
s 0x8049110
"afc cdecl"
s-
axd 0x804c018 0x8049110
axd 0x804c018 0x8049115
axc 0x8049148 0x8049126
axc 0x8049148 0x804912f
axd 0x804c018 0x8049138
afS 28 @ 0x8049110
"f entry.fini0 41 0x08049150"
"af+ 0x08049150 entry.fini0 f n"
afb+ 0x08049150 0x08049150 13 0x08049178 0x0804915d
afb+ 0x08049150 0x0804915d 20 0xffffffffffffffff 0xffffffffffffffff
afb+ 0x08049150 0x08049178 1 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049150
s 0x8049150
"afc cdecl"
s-
axd 0x804c018 0x8049154
axc 0x8049178 0x804915b
axC 0x80490d0 0x8049163
axd 0x804c018 0x8049168
afS 12 @ 0x8049150
"f entry.init0 6 0x08049180"
"af+ 0x08049180 entry.init0 f n"
afb+ 0x08049180 0x08049180 6 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049180
s 0x8049180
"afc cdecl"
s-
axc 0x8049110 0x8049184
afS 0 @ 0x8049180
"f sym.complex_function_2 233 0x080492a5"
"af+ 0x080492a5 sym.complex_function_2 f n"
afb+ 0x080492a5 0x080492a5 233 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x080492a5
s 0x80492a5
"afc cdecl"
s-
s 0x80492a5
'afvb 8 arg_8h uint32_t
s-
afS 4 @ 0x80492a5
"f sym.get_user_input 45 0x08049502"
"af+ 0x08049502 sym.get_user_input f n"
afb+ 0x08049502 0x08049502 45 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049502
s 0x8049502
"afc cdecl"
s-
s 0x8049502
'afvb -12 var_ch int32_t
'afvb -16 var_10h int32_t
'afvb -20 var_14h int32_t
s-
axd 0x804a00b 0x8049514
axC 0x8049060 0x8049519
afS 44 @ 0x8049502
"f sym.__x86.get_pc_thunk.bx 4 0x080490c0"
"af+ 0x080490c0 sym.__x86.get_pc_thunk.bx f n"
afb+ 0x080490c0 0x080490c0 4 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x080490c0
s 0x80490c0
"afc cdecl"
s-
afS 0 @ 0x80490c0
"f sym._fini 20 0x080495d4"
"af+ 0x080495d4 sym._fini f n"
afb+ 0x080495d4 0x080495d4 20 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x080495d4
s 0x80495d4
"afc cdecl"
s-
axC 0x80490c0 0x80495d8
afS 12 @ 0x80495d4
"f sym.complex_function_1 257 0x080491a4"
"af+ 0x080491a4 sym.complex_function_1 f n"
afb+ 0x080491a4 0x080491a4 257 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x080491a4
s 0x80491a4
"afc cdecl"
s-
...
s-
afS 4 @ 0x80491a4
"f sym.complex_function_3 372 0x0804938e"
"af+ 0x0804938e sym.complex_function_3 f n"
afb+ 0x0804938e 0x0804938e 372 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x0804938e
s 0x804938e
"afc cdecl"
s-
...
s-
afS 4 @ 0x804938e
"f sym._dl_relocate_static_pie 1 0x080490b0"
"af+ 0x080490b0 sym._dl_relocate_static_pie f n"
afb+ 0x080490b0 0x080490b0 1 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x080490b0
s 0x80490b0
"afc cdecl"
s-
afS 0 @ 0x80490b0
"f main 163 0x0804952f"
"af+ 0x0804952f main f n"
afb+ 0x0804952f 0x0804952f 104 0x080495a3 0x08049597
afb+ 0x0804952f 0x08049597 6 0x080495a3 0x0804959d
afb+ 0x0804952f 0x0804959d 6 0x080495b5 0x080495a3
afb+ 0x0804952f 0x080495a3 18 0x080495c5 0xffffffffffffffff
afb+ 0x0804952f 0x080495b5 16 0x080495c5 0xffffffffffffffff
afb+ 0x0804952f 0x080495c5 13 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x0804952f
s 0x804952f
"afc cdecl"
s-
s 0x804952f
'afvb -4 argv_addr int32_t
'afvb -12 user_input_1 uint32_t
'afvb -16 user_input_2 uint32_t
'afvb -20 user_input_3 uint32_t
s-
s 0x804952f
'afvs 4 argv char **
s-
axd 0x804a014 0x8049543
axC 0x8049040 0x8049548
axC 0x8049502 0x8049550
axC 0x80491a4 0x8049564
axC 0x80492a5 0x8049575
axC 0x804938e 0x8049586
axc 0x80495a3 0x8049595
axc 0x80495a3 0x804959b
axc 0x80495b5 0x80495a1
axd 0x804a029 0x80495a6
axC 0x8049050 0x80495ab
axc 0x80495c5 0x80495b3
axd 0x804a034 0x80495b8
axC 0x8049050 0x80495bd
afS 48 @ 0x804952f
"f sym.print_msg 30 0x08049186"
"af+ 0x08049186 sym.print_msg f n"
afb+ 0x08049186 0x08049186 30 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049186
s 0x8049186
"afc cdecl"
s-
axd 0x804c019 0x804918f
axd 0x804a008 0x8049194
axC 0x8049040 0x8049199
afS 28 @ 0x8049186
"f sym._init 32 0x08049000"
"af+ 0x08049000 sym._init f n"
afb+ 0x08049000 0x08049000 25 0x0804901b 0x08049019
afb+ 0x08049000 0x08049019 2 0x0804901b 0xffffffffffffffff
afb+ 0x08049000 0x0804901b 5 0xffffffffffffffff 0xffffffffffffffff
afB 32 @ 0x08049000
s 0x8049000
"afc cdecl"
s-
axC 0x80490c0 0x8049004
axc 0x804901b 0x8049017
afS 12 @ 0x8049000
...
aer ebp = 0x00000000
aer eip = 0x0804952f
aer eflags = 0x00000000
# flags
fs sections
f section. 0 0x00000000 
f section..comment 31 0x00000000 
f section..symtab 720 0x00000000 
f section..strtab 581 0x00000000 
f section..shstrtab 257 0x00000000 
fs segments
f segment.GNU_STACK 0 0x00000000 
fs format
f elf_header 52 0x00000000 
fs registers
f oeax 4 0x00000000 
f eax 4 0x00000000 
f ebx 4 0x00000000 
...
f ebp 4 0x00000000 
fs format
f elf_phdr 32 0x00000034 
f elf_strtab 117 0x0000027c 
f elf_shstrtab 257 0x0000354d 
f elf_shdr 40 0x00003650 
fs segments
f segment.LOAD0 872 0x08048000 
f segment.ehdr 52 0x08048000 
f segment.PHDR 384 0x08048034 
fs sections
f section..note.gnu.build_id 36 0x080481b4 
fs segments
f segment.NOTE 36 0x080481b4 
fs sections
f section..interp 19 0x080481d8 
fs segments
f segment.INTERP 19 0x080481d8 
fs sections
f section..gnu.hash 32 0x080481ec 
f section..dynsym 112 0x0804820c 
f section..dynstr 117 0x0804827c 
f section..gnu.version 14 0x080482f2 
f section..gnu.version_r 64 0x08048300 
f section..rel.dyn 8 0x08048340 
f section..rel.plt 32 0x08048348 
f section..init 32 0x08049000 
fs segments
f segment.LOAD1 1512 0x08049000 
fs symbols
f sym._init 32 0x08049000 
fs sections
f section..plt 80 0x08049020 
fs imports
f sym.imp.__libc_start_main 6 0x08049030 
f sym.imp.printf 6 0x08049040 
f sym.imp.puts 6 0x08049050 
...
f entry0 40 0x08049070 
fs sections
f section..text 1378 0x08049070 
fs symbols
f sym._start 50 0x08049070 
fs functions
f fcn.08049099 4 0x08049099 
fs symbols
f loc.__wrap_main 0 0x0804909d 
f sym._dl_relocate_static_pie 1 0x080490b0 
f sym.__x86.get_pc_thunk.bx 4 0x080490c0 
f sym.deregister_tm_clones 49 0x080490d0 
f sym.register_tm_clones 57 0x08049110 
f entry.fini0 41 0x08049150 
f sym.__do_global_dtors_aux 0 0x08049150 
f entry.init0 6 0x08049180 
f sym.frame_dummy 0 0x08049180 
f sym.print_msg 30 0x08049186 
f sym.complex_function_1 257 0x080491a4 
f sym.complex_function_2 233 0x080492a5 
f sym.complex_function_3 372 0x0804938e 
f sym.get_user_input 45 0x08049502 
f main 163 0x0804952f 
f sym.main 163 0x0804952f 
fs registers
f eip 4 0x0804952f 
fs sections
f section..fini 20 0x080495d4 
fs symbols
f sym._fini 20 0x080495d4 
fs sections
f section..rodata 62 0x0804a000 
fs segments
f segment.LOAD2 512 0x0804a000 
fs symbols
f obj._fp_hw 4 0x0804a000 
f obj._IO_stdin_used 4 0x0804a004 
fs strings
f str._x__x__x 9 0x0804a00b 
f str.Enter_the_password: 21 0x0804a014 
f str.Try_again. 11 0x0804a029 
f str.Good_Job. 10 0x0804a034 
fs sections
f section..eh_frame_hdr 84 0x0804a040 
fs segments
f segment.GNU_EH_FRAME 84 0x0804a040 
fs symbols
f loc.__GNU_EH_FRAME_HDR 0 0x0804a040 
fs sections
f section..eh_frame 332 0x0804a094 
fs symbols
f obj.__FRAME_END__ 0 0x0804a1dc 
fs sections
f section..note.ABI_tag 32 0x0804a1e0 
fs segments
f segment.NOTE_1 32 0x0804a1e0 
fs symbols
f obj.__abi_tag 32 0x0804a1e0 
fs sections
f section..init_array 4 0x0804bf00 
fs segments
f segment.LOAD3 284 0x0804bf00 
f segment.GNU_RELRO 256 0x0804bf00 
fs symbols
f obj.__frame_dummy_init_array_entry 0 0x0804bf00 
fs sections
f section..fini_array 4 0x0804bf04 
fs symbols
f obj.__do_global_dtors_aux_fini_array_entry 0 0x0804bf04 
fs sections
f section..dynamic 232 0x0804bf08 
fs segments
f segment.DYNAMIC 232 0x0804bf08 
fs symbols
f obj._DYNAMIC 0 0x0804bf08 
fs sections
f section..got 4 0x0804bff0 
fs relocs
f reloc.__gmon_start__ 4 0x0804bff0 
fs sections
f section..got.plt 28 0x0804bff4 
fs symbols
f obj._GLOBAL_OFFSET_TABLE_ 0 0x0804bff4 
fs relocs
f reloc.__libc_start_main 4 0x0804c000 
f reloc.printf 4 0x0804c004 
f reloc.puts 4 0x0804c008 
f reloc.__isoc99_scanf 4 0x0804c00c 
fs sections
f section..data 8 0x0804c010 
fs symbols
f loc.data_start 0 0x0804c010 
f loc.__data_start 0 0x0804c010 
f obj.__dso_handle 0 0x0804c014 
fs sections
f section..bss 4 0x0804c018 
fs symbols
f obj.completed.0 1 0x0804c018 
f loc._edata 0 0x0804c018 
f loc.__bss_start 0 0x0804c018 
f obj.__TMC_END__ 0 0x0804c018 
f obj.msg 1 0x0804c019 
f loc._end 0 0x0804c01c 
# meta
CCu base64:WzI4XSAtLS0tIHNlY3Rpb24gc2l6ZSAyNTcgbmFtZWQgLnNoc3RydGFi @ 0x00000000
CCu base64:WzAxXSAtci0tIHNlY3Rpb24gc2l6ZSAzNiBuYW1lZCAubm90ZS5nbnUuYnVpbGQtaWQ= @ 0x080481b4
CCu base64:WzAyXSAtci0tIHNlY3Rpb24gc2l6ZSAxOSBuYW1lZCAuaW50ZXJw @ 0x080481d8
CCu base64:WzAzXSAtci0tIHNlY3Rpb24gc2l6ZSAzMiBuYW1lZCAuZ251Lmhhc2g= @ 0x080481ec
CCu base64:WzA0XSAtci0tIHNlY3Rpb24gc2l6ZSAxMTIgbmFtZWQgLmR5bnN5bQ== @ 0x0804820c
Cd 4 @ 0x0804820c
Cd 4 @ 0x08048210
Cd 4 @ 0x08048214
Cd 4 @ 0x08048218
...
Cd 4 @ 0x08048274
Cd 4 @ 0x08048278
CCu base64:WzA1XSAtci0tIHNlY3Rpb24gc2l6ZSAxMTcgbmFtZWQgLmR5bnN0cg== @ 0x0804827c
Cs 15 @ 0x0804827d # _IO_stdin_used
Cs 5 @ 0x0804828c # puts
Cs 18 @ 0x08048291 # __libc_start_main
Cs 7 @ 0x080482a3 # printf
Cs 15 @ 0x080482aa # __isoc99_scanf
Cs 10 @ 0x080482b9 # libc.so.6
Cs 10 @ 0x080482c3 # GLIBC_2.7
Cs 10 @ 0x080482cd # GLIBC_2.0
Cs 11 @ 0x080482d7 # GLIBC_2.34
Cs 15 @ 0x080482e2 # __gmon_start__
CCu base64:WzA2XSAtci0tIHNlY3Rpb24gc2l6ZSAxNCBuYW1lZCAuZ251LnZlcnNpb24= @ 0x080482f2
CCu base64:WzA3XSAtci0tIHNlY3Rpb24gc2l6ZSA2NCBuYW1lZCAuZ251LnZlcnNpb25fcg== @ 0x08048300
CCu base64:WzA4XSAtci0tIHNlY3Rpb24gc2l6ZSA4IG5hbWVkIC5yZWwuZHlu @ 0x08048340
CCu base64:WzA5XSAtci0tIHNlY3Rpb24gc2l6ZSAzMiBuYW1lZCAucmVsLnBsdA== @ 0x08048348
Cd 4 @ 0x08048348
Cd 4 @ 0x0804834c
Cd 4 @ 0x08048350
Cd 4 @ 0x08048354
...
Cd 4 @ 0x08048360
Cd 4 @ 0x08048364
CCu base64:WzEwXSAtci14IHNlY3Rpb24gc2l6ZSAzMiBuYW1lZCAuaW5pdA== @ 0x08049000
CCu base64:WzExXSAtci14IHNlY3Rpb24gc2l6ZSA4MCBuYW1lZCAucGx0 @ 0x08049020
CCu base64:WzEyXSAtci14IHNlY3Rpb24gc2l6ZSAxMzc4IG5hbWVkIC50ZXh0 @ 0x08049070
Ct char **ubp_av @ 0x0804908a
Ct int argc @ 0x0804908b
Ct func main @ 0x08049092
Ct const char *format @ 0x08049194
CCu base64:5Lya6KaB5rGC55So5oi36L6T5YWl5LiJ5Liq5Lul56m65qC85YiG5Ymy55qE5pWw5a2X77yM5YiG5Yir5a2Y5YWl5aaC5LiL55qE5LiJ5Liq5Y+Y6YeP5Lit @ 0x08049550
Ct int32_t arg_8h @ 0x08049561
Ct int32_t arg_8h @ 0x08049572
Ct int32_t arg_8h @ 0x08049583
CCu base64:5LuO5qCI5LiK5oGi5aSN5LmL5YmN5L+d5a2Y55qEIGVjeCAo6YeM6Z2i5piv5a+56b2Q5YmNIGVzcCs0LOWNsyBhcmd2IOWcsOWdgCnjgII= @ 0x080495ca
CCu base64:ZWN4IOaYr+Wvuem9kOWJjeeahCBlc3ArNCzmiYDku6UgZWN4LTQg5bCx5piv5a+56b2Q5YmN55qEZXNwLOWNs+iwg+eUqOiAheWOi+WFpei/lOWbnuWcsOWdgOWQjueahOagiOmhtuOAgui/meagt+WwseaBouWkjeS6huiwg+eUqOiAheacn+acm+eahOagiOW4g+WxgOOAgg== @ 0x080495ce
CCu base64:WzEzXSAtci14IHNlY3Rpb24gc2l6ZSAyMCBuYW1lZCAuZmluaQ== @ 0x080495d4
CCu base64:WzE0XSAtci0tIHNlY3Rpb24gc2l6ZSA2MiBuYW1lZCAucm9kYXRh @ 0x0804a000
Cs 9 @ 0x0804a00b # %x %x %x
Cs 21 @ 0x0804a014 # Enter the password: 
Cs 11 @ 0x0804a029 # Try again.
Cs 10 @ 0x0804a034 # Good Job.
CCu base64:WzE1XSAtci0tIHNlY3Rpb24gc2l6ZSA4NCBuYW1lZCAuZWhfZnJhbWVfaGRy @ 0x0804a040
CCu base64:WzE2XSAtci0tIHNlY3Rpb24gc2l6ZSAzMzIgbmFtZWQgLmVoX2ZyYW1l @ 0x0804a094
CCu base64:WzE3XSAtci0tIHNlY3Rpb24gc2l6ZSAzMiBuYW1lZCAubm90ZS5BQkktdGFn @ 0x0804a1e0
Cd 4 @ 0x0804bf00
CCu base64:WzE4XSAtcnctIHNlY3Rpb24gc2l6ZSA0IG5hbWVkIC5pbml0X2FycmF5 @ 0x0804bf00
Cd 4 @ 0x0804bf04
CCu base64:WzE5XSAtcnctIHNlY3Rpb24gc2l6ZSA0IG5hbWVkIC5maW5pX2FycmF5 @ 0x0804bf04
CCu base64:WzIwXSAtcnctIHNlY3Rpb24gc2l6ZSAyMzIgbmFtZWQgLmR5bmFtaWM= @ 0x0804bf08
Cd 4 @ 0x0804bf08
Cd 4 @ 0x0804bf0c
Cd 4 @ 0x0804bf10
Cd 4 @ 0x0804bf14
...
Cd 4 @ 0x0804bfe8
Cd 4 @ 0x0804bfec
CCu base64:WzIxXSAtcnctIHNlY3Rpb24gc2l6ZSA0IG5hbWVkIC5nb3Q= @ 0x0804bff0
Cd 4 @ 0x0804bff0
CCu base64:WzIyXSAtcnctIHNlY3Rpb24gc2l6ZSAyOCBuYW1lZCAuZ290LnBsdA== @ 0x0804bff4
Cd 4 @ 0x0804c000
Cd 4 @ 0x0804c004
Cd 4 @ 0x0804c008
Cd 4 @ 0x0804c00c
CCu base64:WzIzXSAtcnctIHNlY3Rpb24gc2l6ZSA4IG5hbWVkIC5kYXRh @ 0x0804c010
CCu base64:WzI0XSAtcnctIHNlY3Rpb24gc2l6ZSA0IG5hbWVkIC5ic3M= @ 0x0804c018
axC 0x80490c0 0x8049004
axc 0x804901b 0x8049017
axd 0x804bff8 0x8049020
axc 0x804bffc 0x8049026
axc 0x804c000 0x8049030
axc 0x8049020 0x804903b
axc 0x804c004 0x8049040
axc 0x8049020 0x804904b
axc 0x804c008 0x8049050
axc 0x8049020 0x804905b
axc 0x804c00c 0x8049060
axc 0x8049020 0x804906b
axC 0x8049099 0x804907b
axC 0x8049030 0x8049093
axc 0x804952f 0x804909d
axd 0x804c018 0x80490d0
axd 0x804c018 0x80490d5
axc 0x8049100 0x80490da
axc 0x8049100 0x80490e3
...
"tk enum.elf_s_flags_32=SF32_None,SF32_Exec,SF32_Alloc,SF32_Alloc_Exec,SF32_Write,SF32_Write_Exec,SF32_Write_Alloc,SF32_Write_Alloc_Exec"
"tk enum.elf_s_flags_32.0x0=SF32_None"
"tk enum.elf_s_flags_32.0x1=SF32_Exec"
"tk enum.elf_s_flags_32.0x2=SF32_Alloc"
"tk enum.elf_s_flags_32.0x3=SF32_Alloc_Exec"
"tk enum.elf_s_flags_32.0x4=SF32_Write"
"tk enum.elf_s_flags_32.0x5=SF32_Write_Exec"
"tk enum.elf_s_flags_32.0x6=SF32_Write_Alloc"
"tk enum.elf_s_flags_32.0x7=SF32_Write_Alloc_Exec"
"tk enum.elf_s_flags_32.SF32_Alloc=0x2"
"tk enum.elf_s_flags_32.SF32_Alloc_Exec=0x3"
"tk enum.elf_s_flags_32.SF32_Exec=0x1"
"tk enum.elf_s_flags_32.SF32_None=0x0"
"tk enum.elf_s_flags_32.SF32_Write=0x4"
"tk enum.elf_s_flags_32.SF32_Write_Alloc=0x6"
"tk enum.elf_s_flags_32.SF32_Write_Alloc_Exec=0x7"
"tk enum.elf_s_flags_32.SF32_Write_Exec=0x5"
...
"tk func.sym.complex_function_1.arg.0=uint32_t,arg_8h"
"tk func.sym.complex_function_1.args=1"
"tk func.sym.complex_function_2.arg.0=uint32_t,arg_8h"
"tk func.sym.complex_function_2.args=1"
"tk func.sym.complex_function_3.arg.0=uint32_t,arg_8h"
"tk func.sym.complex_function_3.args=1"
